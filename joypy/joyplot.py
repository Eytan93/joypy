...
def plot_density(ax, x_range, v, kind="kde", bw_method=None,
    ...
    median = np.median(v)
    std = np.std(v)
    #ax.vlines(mean, 0, np.interp(mean, x_range, y), color='k',ls=':')
    #ax.vlines(median, 0, np.interp(mean, x_range, y), color='k', ls='--')
    #ax.vlines((mean+std), 0, np.interp(mean+std, x_range, y), color='k',ls='-.')
    #ax.vlines((mean-std), 0, np.interp(mean-std, x_range, y), color='k',ls='-.')
    ...
    #ax.vlines(np.median(v), 0, np.interp(np.median(v), v, y), color='k', ls='--')
    #ax.vlines((np.mean(v)-np.std(v)), 0, np.interp(np.mean(v)-np.std(y), v, y), color='k',ls='-.')
    #ax.vlines((np.mean(v)+np.std(v)), 0, np.interp(np.mean(v)-np.std(y), v, y), color='k',ls='-.')
